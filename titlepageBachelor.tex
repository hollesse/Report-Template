\begin{titlepage}
	...
	>{\centering\arraybackslash}p{.5\textwidth}}
	  {\includegraphics*[width=4.7cm]{\companylogo}} & 
	  {\includegraphics*[width=4.7cm]{dhbwlogo}}
	\end{longtable}
	...
	\begin{center}
	  ...
	  \vspace*{3mm} 	{\bf \academicdegree}\\
	  \vspace*{12mm}	\opt{de}{des Studienganges}\opt{en}{in} \studiengang\\

...
% uncomment if you need a lock flag (only availabe in german)
...
% "fancy forest"
	...
	%\definecolor{TertiaryAccentColor} {rgb}{0.67, 0.74, 0.20}
...
% if you want to, you can also change the supporting colors:
